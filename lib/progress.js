...
// A record is kept per difficulty AND per source. Beating your time on Expert
// says something very different from beating it on Easy, and a board dealt from
// the collection is a different proposition from one the watch rolled on the
// spot - the collection never repeats itself, so working through it is a run
// rather than a series of unrelated attempts.
