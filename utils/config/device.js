...
// drives every layout decision, from the size of an island to how far the map
// may be dragged. Taking the smaller side keeps that true even if a device
// reports a pixel of slop between width and height.
